    ...
    <div class="row mt-3 justify-content-center">
        ...
        <div class="card card-body col-md-8 bg-light shadow-lg  mt-5">
            ...
            <div class="form-group col-lg-6">
                ...
                <input class="form-control" type="text" id="bday" placeholder="Birthday" name="birthday" value="<?php echo set_value('birthday'); ?>" onfocus="(this.type='date')" onblur="(this.type='text')">
            </div><!-- Form Group -->

            <!-- Phone Number -->
            <div class="form-group col-lg-6">
                <label class="form-control-label sr-only" for="phone">Phone number</label>
                <input class="form-control" type="text" id="phone" placeholder="Phone number" name="phone" value="<?php echo set_value('phone'); ?>">
            </div><!-- Form Group -->
            ...
            <div class="form-group col-12 mb-5">
                ...
                <input class="form-control" type="text" id="address" placeholder="Address" name="address" value="<?php echo set_value('address'); ?>">
            </div><!-- Form Group -->
