...
<div class="container">
    <div class="row mt-3 justify-content-center">
        ...
        <div class="card card-body col-md-7 bg-light shadow-lg  mt-5">
            ...
            <!-- CI form helper -->
            <?php echo form_open('Users/login', 'class="form-row"'); ?><!-- Form Start -->
                ...
                <div class="col-12 text-center">
                    <span>No account? </span><a class="text-decoration-none" href="<?php echo base_url('users/register'); ?>">Register</a>
                </div>
